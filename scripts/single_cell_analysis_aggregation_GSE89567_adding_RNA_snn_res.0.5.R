...
output_folder <- "C:/Users/Administrator/Desktop/single_cell_analysis_aggregation/GSE89567_h5friendly.h5seurat_pseudo_bulk_adding_RNA_snn_res.0.5"
...
# Specify File Paths:
file <- file.path(output_folder, "GSE89567_expression_matrix_adding_RNA_snn_res.0.5.txt")
meta_file <- file.path(output_folder, "GSE89567_meta_information_adding_RNA_snn_res.0.5.txt")
