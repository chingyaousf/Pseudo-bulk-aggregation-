...
output_folder <- "C:/Users/Administrator/Desktop/single_cell_analysis_aggregation/GSE84465_h5friendly.h5seurat_pseudo_bulk"
...
# Specify File Paths:
file <- file.path(output_folder, "GSE84465_expression_matrix.txt")
meta_file <- file.path(output_folder, "GSE84465_meta_information.txt")
