...
#Load Seurat Object:
h5_friendly.h5seurat <- LoadH5Seurat("C:/Users/Administrator/Desktop/single_cell_analysis_aggregation/mouse_batch2/GSE177901_h5friendly.h5seurat") 

# Create the directory if it doesn't exist
output_folder <- "C:/Users/Administrator/Desktop/single_cell_analysis_aggregation/mouse_batch2/GSE177901_h5friendly.h5seurat_pseudo_bulk_adding_RNA_snn_res.0.5"
if (!dir.exists(output_folder)) {
  dir.create(output_folder, recursive = TRUE)
}

# Save the metadata to a text file in the specified path with column names
write.table(h5_friendly.h5seurat@meta.data, file.path(output_folder, "GSE177901_h5friendly.h5seurat_meta.txt"), sep="\t", row.names = TRUE, col.names = TRUE)
...
# Specify File Paths:
file <- file.path(output_folder, "GSE177901_expression_matrix_adding_RNA_snn_res.0.5.txt")
meta_file <- file.path(output_folder, "GSE177901_meta_information_adding_RNA_snn_res.0.5.txt")
