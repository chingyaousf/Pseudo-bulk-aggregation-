...
output_folder <- "C:/Users/Administrator/Desktop/single_cell_analysis_aggregation/GSE162631_merge_tumor_h5.h5seurat_pseudo_bulk_adding_integrated_snn_res.0.5"
...
agg = AggregateExpression(h5_friendly.h5seurat, return.seurat = T, group.by = c('orig.ident', 'seurat_clusters_gabby_annotation_revised_v4', 'integrated_snn_res.0.5'), normalization.method = "LogNormalize",scale.factor = 10000)
...
# Specify File Paths:
file <- file.path(output_folder, "GSE162631_merge_tumor_expression_matrix_adding_integrated_snn_res.0.5.txt")
meta_file <- file.path(output_folder, "GSE162631_merge_tumor_meta_information_adding_integrated_snn_res.0.5.txt")
